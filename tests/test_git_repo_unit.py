...
from apache_buildish_release_tooling.git_repo import GitRepository, require_worktree_root
...
class GitRepositoryUnitTest(unittest.TestCase):
    ...
    def test_require_worktree_root_delegates_to_current_worktree_root(self) -> None:
        with mock.patch(
            "apache_buildish_release_tooling.git_repo.current_worktree_root",
