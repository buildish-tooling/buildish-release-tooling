...
class SummaryWriterTest(unittest.TestCase):
    ...
    def test_summary_blocks(self) -> None:
        ...
        self.assertIn("abc123  apache-buildish-example-1.2.3-incubating-src.tar.gz", content)
        self.assertIn("def456  apache-buildish-example-1.2.3-incubating-src.tar.gz", content)
