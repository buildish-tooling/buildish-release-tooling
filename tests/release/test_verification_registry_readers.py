...
class VerificationRegistryReadersTest(unittest.TestCase):
        ...
        for payload_bytes in malformed_payloads:
            with self.subTest(payload_bytes=payload_bytes):
                with self.assertRaisesRegex(
                    ...
                    _simple_index_json_entries(
                        "https://example.invalid/simple/example-project/",
                        payload_bytes,
                    )
    ...
    def test_simple_index_json_entries_skips_incomplete_entries_and_normalizes_hashes(self) -> None:
        ...
        self.assertEqual(
            "https://example.invalid/simple/example-project/packages/buildish_example-1.2.3-py3-none-any.whl",
            entries[0].url,
        )
        self.assertEqual(
            {
    ...
    def test_typed_npm_registry_metadata_skips_incomplete_versions(self) -> None:
        metadata = _typed_npm_registry_metadata(
            _NpmRegistryMetadataRead.model_validate(
                {
                    "versions": {
                        "1.2.3": {
                            ...
                            "version": "1.2.3",
                            "dist": {
                                "tarball": "https://registry.example.invalid/example-project/-/example-project-1.2.3.tgz",
            ...
            metadata_url="https://registry.example.invalid/example-project",
        ...
        self.assertEqual("example-project", version_entry.name)
        self.assertEqual("1.2.3", version_entry.version)
        self.assertEqual(
            "https://registry.example.invalid/example-project/-/example-project-1.2.3.tgz",
    ...
    def test_npm_registry_package_metadata_reports_normalized_malformed_payload_error(self) -> None:
        with mock.patch(
            ...
            return_value=(("https://registry.example.invalid/example-project", "plain-path"),),
        ), mock.patch(
            ...
            with self.assertRaisesRegex(
                ValueError,
                "npm-package registry metadata could not be fetched for example-project: "
                "https://registry.example.invalid/example-project: "
                "npm-package registry metadata at https://registry.example.invalid/example-project "
            ...
            with self.subTest(error_fragment=error_fragment):
                with mock.patch(
                    ...
                    with self.assertRaisesRegex(ValueError, error_fragment):
                        _inspect_image_ref("ghcr.io/apache/example-project:latest")
