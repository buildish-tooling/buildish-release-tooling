...
class GitHubReleasesTest(unittest.TestCase):
    ...
    def test_list_releases_filters_to_object_entries(self) -> None:
        with mock.patch(
            ...
            actual = github_releases.list_releases("apache/example-project")
    ...
    def test_matching_draft_release_ids_matches_by_tag_or_name(self) -> None:
        actual = github_releases.matching_draft_release_ids(
            [
                ...
                {"id": 12, "draft": True, "tag_name": "v0.9.0", "name": "Apache Example Project 1.2.3"},
                {"id": 13, "draft": False, "tag_name": "v1.2.3", "name": "Apache Example Project 1.2.3"},
            ],
            tag_names=["v1.2.3", "v1.2.3-rc2"],
            release_name="Apache Example Project 1.2.3",
        )
    ...
    def test_delete_release_uses_delete_api_call(self) -> None:
        with mock.patch(
            ...
            github_releases.delete_release("apache/example-project", 42)
        run_command.assert_called_once_with(
            [
                ...
                "repos/apache/example-project/releases/42",
            ],
    ...
    def test_delete_release_asset_uses_delete_api_call(self) -> None:
        with mock.patch(
            ...
            github_releases.delete_release_asset("apache/example-project", 99)
        run_command.assert_called_once_with(
            [
                "gh",
                "api",
                ...
                "-H",
                "Accept: application/vnd.github+json",
                "repos/apache/example-project/releases/assets/99",
            ],
            capture_output=False,
        )
    ...
    def test_create_draft_release_posts_expected_payload(self) -> None:
        ...
        run_command.assert_called_once_with(
            [
                ...
                "-H",
                "Accept: application/vnd.github+json",
                "repos/apache/example-project/releases",
                "--input",
                "-",
            ],
