            ...
            release_config=ReleaseConfig.model_validate(
                {
                    ...
                    "source": {
                        ...
                        "snapshot": {
                            "mode": "built-asset",
                            "filename_template": "example-project-{version}-src.tar.gz",
                            "archive_root_template": "example-project-{version}-src",
                        },
                    },
                    ...
                    "policy_profiles": {
                        "asf": {
                            "dist_dev_base": "https://dist.apache.org/repos/dist/dev/example-project",
                            "dist_release_base": "https://dist.apache.org/repos/dist/release/example-project",
