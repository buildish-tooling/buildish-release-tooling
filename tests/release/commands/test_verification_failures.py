...
class VerificationFailureCommandTest(VerificationCommandsIntegrationTestBase):
    ...
    def test_verify_rc_command_reports_progress_for_failed_run(self) -> None:
        ...
        self.assertIn(
            f"  Report JSON: {fixture.work_dir / 'verify-rc-report-example-project-v1.2.3-rc0.json'}",
            completed.stderr,
        )
        self.assertIn(
            f"  Report Markdown: {fixture.work_dir / 'verify-rc-report-example-project-v1.2.3-rc0.md'}",
            completed.stderr,
        )
