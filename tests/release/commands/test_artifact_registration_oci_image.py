            ...
            [
                {
                    ...
                    "uri": f"oci://ghcr.io/apache/example-project@{digest.lower()}",
                    "registry": "ghcr.io",
    ...
    def test_record_artifact_oci_image_command_derives_manifest_bundle_from_multiplatform_image_ref(
        ...
        completed = run_cli(
            [
                ...
                "container-image",
                "--image-ref",
                "ghcr.io/apache/example-project:1.2.3",
                "--artifact-origin",
                "source-commit",
                "--git-commit-sha",
                "0123456789abcdef0123456789abcdef01234567",
            ...
            [
                {
                    ...
                    "kind": "oci-image",
                    "role": "container-image",
                    "uri": f"oci://ghcr.io/apache/example-project@{top_level_digest}",
                    "registry": "ghcr.io",
                    "repository": "apache/example-project",
                    "digest": top_level_digest,
                    "platform_digests": [
        ...
        self.assertEqual(
            ["ghcr.io/apache/example-project:1.2.3|{{json .Manifest}}"],
            ...
            [
                {
                    ...
                    "kind": "oci-image",
                    "uri": f"oci://docker.io/apache/example-project@{top_level_digest}",
                    "registry": "docker.io",
                    "repository": "apache/example-project",
                    "digest": top_level_digest,
                }
