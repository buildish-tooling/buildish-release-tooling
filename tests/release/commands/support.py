...
class ReleaseCommandsIntegrationTestSupport(unittest.TestCase):
    ...
    def _write_component_config(
        ...
        *,
        ...
        vote_release_name: str = "Apache Example Project",
        ...
        config_path.write_text(
            "\n".join(
                [
                    ...
                    "  signing:",
                    "    kind: openpgp",
                    "    private_key_env: BUILDISH_GPG_PRIVATE_KEY",
                    "    passphrase_env: BUILDISH_GPG_PASSPHRASE",
                    "publication:",
                    "  authoritative:",
                    "    kind: asf-dist-svn",
                    "  secondary:",
        ...
        manifest_text = json.dumps(
            {
                ...
                "trust_roots": {
                    "asf_keys": {
                        "uri": f"{repo_url}/dist/release/incubator/example/KEYS",
                ...
                "draft_github_release": {
                    ...
                    "url": f"https://github.com/apache/example-project/releases/tag/v{version}-rc{rc_number}",
                },
                "vote_materials": {
                    "source_artifacts": [
                        {
                            ...
                            "uri": (
                                f"{repo_url}/dist/dev/incubator/example/{component_id}/"
                ...
                "verification": {
                    "staging_svn_url": (
                        f"{repo_url}/dist/dev/incubator/example/{component_id}/{version}-rc{rc_number}/"
                    ),
