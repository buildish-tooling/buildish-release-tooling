...
class GitHubReleasePublicationCommandIntegrationTest(ReleasePublicationCommandTestBase):
    ...
    def test_sync_draft_github_release_command_recreates_matching_draft_release(
        ...
        set_github_origin_url(clone_dir, "apache/example-project")
        (clone_dir / "DISCLAIMER").write_text(
            "Apache Example Project is an effort undergoing incubation.\n",
            encoding="utf-8",
        )
        ...
        gh_path, gh_state_dir = create_fake_gh_launcher(
            ...
            list_response=[
                ...
                },
                {
                    ...
                    "draft": False,
                    "tag_name": "v1.2.2",
                    "name": "Apache Example Project 1.2.2",
                },
            ],
            create_response={
                "id": 42,
                "tag_name": "v1.2.3-rc3",
                "name": "Apache Example Project 1.2.3",
                "html_url": "https://github.com/apache/example-project/releases/tag/v1.2.3-rc3",
            },
        )
        completed = run_cli(
            [
        ...
        self.assertEqual("apache/example-project", manifest["repository_slug"])
        ...
        self.assertEqual(
            "https://github.com/apache/example-project/releases/tag/v1.2.3-rc3",
        ...
        self.assertEqual("Apache Example Project 1.2.3", create_request["name"])
        ...
        self.assertIn(
            "ASF SVN staging URL: https://dist.apache.org/repos/dist/dev/incubator/example/example-project/1.2.3-rc3/",
            create_request["body"],
        )
        deleted_endpoints = (
        ...
        self.assertEqual(
            [
                "repos/apache/example-project/releases/11",
                "repos/apache/example-project/releases/12",
            ],
            deleted_endpoints,
        )
    ...
    def test_sync_draft_github_release_reuses_same_rc_without_deleting_assets(
        ...
        release_body = "\n".join(
            [
                "Candidate GitHub Release placeholder for Apache Example Project 1.2.3.",
                "",
                "Candidate tag: v1.2.3-rc0",
                "Final tag: v1.2.3",
                f"Resolved source ref: {expected_commit}",
                "ASF SVN staging URL: https://dist.apache.org/repos/dist/dev/incubator/example/example-project/1.2.3-rc0/",
            ...
            list_response=[
                {
                    ...
                    "name": "Apache Example Project 1.2.3",
                    "body": release_body,
                    "html_url": "https://github.com/apache/example-project/releases/tag/v1.2.3-rc0",
                }
            ],
        )
        completed = run_cli(
    ...
    def test_sync_draft_github_release_can_publish_public_candidate_prerelease(
        ...
        gh_path, gh_state_dir = create_fake_gh_launcher(
            ...
            create_response={
                ...
                "name": "Apache Example Project 1.2.3",
                "html_url": "https://github.com/apache/example-project/releases/tag/v1.2.3-alpha1",
            },
        )
        completed = run_cli(
            [
            ...
            list_response=[
                {
                    ...
                    "name": "Apache Example Project 1.2.3",
                    "body": release_body,
                    "html_url": "https://github.com/apache/example-project/releases/tag/v1.2.3",
                }
            ],
    ...
    def test_finalize_draft_github_release_command_publishes_existing_draft(
        ...
        rc_vote_manifest_text = self._rc_vote_manifest_text(
            ...
            incubator_disclaimer_text="Apache Example Project is an effort undergoing incubation.",
            asf_keys_url=keys_path.as_uri(),
        )
        ...
        self.assertEqual(expected_commit, update_request["target_commitish"])
        self.assertEqual("Apache Example Project 1.2.3", update_request["name"])
        ...
        self.assertIn(
            "https://dist.apache.org/repos/dist/release/incubator/example/example-project/1.2.3/",
            update_request["body"],
        )
        self.assertIn(
            "apache-example-project-1.2.3-incubating-src.tar.gz.asc",
            update_request["body"],
        )
        self.assertIn(
        ...
        self.assertEqual(
            [
                "repos/apache/example-project/releases/assets/201",
                "repos/apache/example-project/releases/assets/202",
                "repos/apache/example-project/releases/assets/204",
            ],
