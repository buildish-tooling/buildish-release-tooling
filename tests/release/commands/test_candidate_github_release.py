...
class GitHubCandidateLifecycleIntegrationTest(unittest.TestCase):
    ...
    def _release(
        ...
        *,
        ...
        return {
            ...
            "html_url": (
                "https://github.com/apache/example-project/releases/tag/"
    ...
    def test_asf_vote_profile_is_an_extension_over_the_same_candidate_manifest(
        ...
        self.assertEqual(
            "https://downloads.apache.org/example/KEYS",
    ...
    def test_exact_candidate_two_promotes_to_unsuffixed_final_release(self) -> None:
        ...
        final_draft = {
            ...
            "prerelease": False,
            "html_url": (
                "https://github.com/apache/example-project/releases/tag/v1.2.3"
            ),
            "assets": [],
        }
