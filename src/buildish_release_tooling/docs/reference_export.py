...
from buildish_release_tooling.docs.reference_docs import (
    ReferenceDocError,
    TypeReferenceTarget,
...
from buildish_release_tooling.docs.reference_docs.registry import (
...
if TYPE_CHECKING:
    from buildish_release_tooling.docs.schema_export import SchemaExample, SchemaExport
...
_PUBLISHED_SCHEMA_PATH_PREFIX = "/components/release-tooling/schemas"
