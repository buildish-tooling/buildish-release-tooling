...
MODEL_SECTION_DEFINITIONS = (
    ...
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_release_tooling.release.contracts",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_release_tooling.release.command_manifests",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_release_tooling.harness.config",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_release_tooling.harness.models",),
    ),
    ModelSectionDefinition(
        ...
        module_prefixes=("buildish_release_tooling.harness.shim_builtins",),
    ),
)
