...
Buildish itself does not select this profile. It is available only for Apache projects that
explicitly choose the adapter and apply their current ASF policy.
